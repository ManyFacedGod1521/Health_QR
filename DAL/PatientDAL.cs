...
namespace Health_QR.DAL
{
    public class PatientDAL
    {
        ...
        {
            string commandText =
                $"INSERT INTO [dbo].[Patient] ([First_Name],[Last_Name],[Current_And_Past_Medications],[Medication_Food_And_Other_Allergies],[Past_Medical_History],[Past_Surgical_History],[Family_History],[Social_History],[UniquePatientId])" +
                $"VALUES (@First_Name, @Last_Name, @Current_And_Past_Medications, @Medication_Food_And_Other_Allergies, @Past_Medical_History, @Past_Surgical_History , @Family_History, @Social_History, @UniquePatientId)";
